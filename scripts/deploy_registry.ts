...
async function main() {
  ...
  const sierraPath = "contracts/target/dev/starkaudit_AuditRegistry.contract_class.json"
  const casmPath = "contracts/target/dev/starkaudit_AuditRegistry.compiled_contract_class.json"
