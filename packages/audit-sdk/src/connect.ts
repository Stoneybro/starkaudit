...
// Re-exported for scripts/ (CommonJS-classified): importing the SDK root
// directly from scripts/ fails (no "default" export condition), so all
// SDK surface goes through this ESM module. See scripts/payroll.ts.
export { Open }
