  ...
  return (
    <section className="py-40 px-6 md:px-12 bg-white text-on-primary relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          Your business is already transacting privately. Your audit trail should be public where it counts.
        </motion.h2>
        ...
        >
          StarkAudit is live on Starknet Sepolia. Blinded audit records for the onchain economy.
        </motion.p>
