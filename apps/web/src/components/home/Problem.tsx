      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-semibold tracking-tight mb-16 leading-tight">
            Private transfers protect your business, but blind your auditors.
          </h2>
          <motion.div 
            initial={{ scaleX: 0 }}
          ...
          <p className="text-lg text-on-surface-variant max-w-2xl leading-relaxed">
            Privacy pools let businesses hide payment amounts and counterparties, but this blinds external auditors. A business using private on-chain payments currently has to choose between handing over its full transaction history (destroying privacy) or asking auditors to just trust them.
          </p>
        </motion.div>
      </div>
    </section>
