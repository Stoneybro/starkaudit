...
const usecases = [
  {
    ...
    num: '01',
    body: 'Give VCs and board members cryptographically verified audit outcomes without exposing vendor payments, salaries or deal flow.',
  },
  {
  ...
  {
    title: 'Regulated Tokens',
    num: '03',
    body: 'Maintain continuous compliance attestations for private STRK20 transfers to satisfy traditional accounting and regulatory requirements.',
  },
  {
    title: 'Web3 DAOs',
    num: '04',
    ...
    <section className="py-32 px-6 md:px-12 bg-surface">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-start">
          ...
          >
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-outline block mb-4">Who is StarkAudit for?</span>
